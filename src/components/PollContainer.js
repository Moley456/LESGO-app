...
export default (props) => {
  ...
  const currentUser = useState(Auth.getCurrentUserName());

  useEffect(() => {
    //set total votes
    db.ref("app/rooms/" + props.roomUID + "/details/totalVotes").once(
      "value",
      (value) => {
  ...
  const handleVote = (selectedChoice) => {
    ...
    db.ref("app/rooms/" + props.roomUID + "/participants/" + currentUser).once(
      "value",
      (choice) => {
        if (
          choice.val() !== "-" &&
          ...
          db.ref(
            "app/rooms/" + props.roomUID + "/polls/" + choice.val() + "/votes"
          ).set(firebase.database.ServerValue.increment(-1));
        } else {
          db.ref("app/rooms/" + props.roomUID + "/details/totalVotes").set(
    ...
    db.ref("app/rooms/" + props.roomUID + "/polls/" + selection + "/votes").set(
      firebase.database.ServerValue.increment(1)
    );
      ...
      >
        <View style={styles.modalView}>
          ...
          <Text style={styles.modalWarningText}>
            Voting again will overwrite your previous vote!
          </Text>
          <TouchableOpacity
